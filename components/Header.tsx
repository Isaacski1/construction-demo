...
import { Menu, X, Phone, Mail, Facebook, Twitter, Linkedin, Instagram, Search } from 'lucide-react';
...
const Header: React.FC = () => {
  ...
  return (
    <header className="w-full z-40">
      ...
      <div className="bg-primary py-2 px-4 hidden md:block">
        <div className="max-w-7xl mx-auto flex justify-between items-center text-secondary font-medium text-sm">
          ...
          <div className="flex items-center gap-4">
            <span className="uppercase tracking-wider font-bold text-xs">Follow Us:</span>
      ...
      {/* Main Navbar */}
      <div className={`w-full transition-all duration-300 ${isScrolled ? 'fixed top-0 bg-white shadow-md py-3' : 'relative bg-white py-5'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            {/* Logo */}
            <div className="flex items-center gap-2">
              <div className="bg-primary w-10 h-10 flex items-center justify-center rounded text-secondary font-bold text-2xl">B</div>
              <span className="text-2xl font-heading font-bold text-secondary tracking-tight">BUILD<span className="text-primary">MAX</span></span>
            </div>
